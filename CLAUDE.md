...
- **Safety scope.** This is a tool to explore **public, de-identified, aggregate** survey data — *not* medical or clinical advice. No individual-level inference, no health recommendations. Every figure must carry its survey-weighted basis and source, in product copy and in the chatbot's own framing.
