...
`app/main.py` (which imports `nhis_okf.agentcore_app`) cannot be imported
...
# (The deploy entrypoint / vendoring is now a separate repo — ../nhisokfchat, the clean
# deployable version. Those runtime-packaging tests live there; the lab tests the engine.)
